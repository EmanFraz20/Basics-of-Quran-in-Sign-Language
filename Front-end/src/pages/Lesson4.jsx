...
function Lesson4() {
  ...
  useEffect(() => {
    const getLesson = async () => {
      try {
        const res = await axios.get("/api/lesson4/lesson4");
  ...
  return (
    ...
    <div className='min-h-screen'>
      ...
      <div className="max-w-3xl mx-auto text-center mt-20 pt-6">
        ...
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500">Lesson 4</span>
