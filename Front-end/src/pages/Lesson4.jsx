        ...
        <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
          <div className="max-w-3xl mx-auto text-center mt-20 pt-6">
            ...
            <p className="text-lg text-gray-800 mb-8">
              Alphabets are the building blocks so need special attention.
              Remember, if not taught properly, both the student and teacher
              will be in trouble in latter lessons.
            </p>
          </div>
